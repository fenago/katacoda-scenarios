...
`cd web-scraping-with-python/Chapter08`{{execute}}
...
- Click **IDE Editor** tab to open Visual Studio and open solution explorer and open `web-scraping-with-python/Chapter08` to view code files.
