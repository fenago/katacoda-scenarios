...
`cd web-scraping-with-python/Chapter06`{{execute}}
...
- Click **IDE Editor** tab to open Visual Studio and open solution explorer and open `web-scraping-with-python/Chapter06` to view code files.
