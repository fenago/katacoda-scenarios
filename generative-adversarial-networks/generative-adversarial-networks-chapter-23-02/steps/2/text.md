...
`cd generative-adversarial-networks/chapter_23`{{execute}}
...
- Click **IDE Editor** tab to open Visual Studio and open solution explorer and open `generative-adversarial-networks/chapter_23` to view files.
