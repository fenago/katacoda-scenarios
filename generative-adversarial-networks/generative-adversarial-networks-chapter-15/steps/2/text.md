...
`cd generative-adversarial-networks/chapter_15`{{execute}}
...
- Click **IDE Editor** tab to open Visual Studio and open solution explorer and open `generative-adversarial-networks/chapter_15` to view files.
