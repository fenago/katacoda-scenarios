...
`cd generative-adversarial-networks/chapter_16`{{execute}}
...
- Click **IDE Editor** tab to open Visual Studio and open solution explorer and open `generative-adversarial-networks/chapter_16` to view files.
