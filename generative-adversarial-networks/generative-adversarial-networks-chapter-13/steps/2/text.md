...
`cd generative-adversarial-networks/chapter_13`{{execute}}
...
- Click **IDE Editor** tab to open Visual Studio and open solution explorer and open `generative-adversarial-networks/chapter_13` to view files.
