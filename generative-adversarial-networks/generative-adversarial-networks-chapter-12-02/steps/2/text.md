...
`cd generative-adversarial-networks/chapter_12`{{execute}}
...
- Click **IDE Editor** tab to open Visual Studio and open solution explorer and open `generative-adversarial-networks/chapter_12` to view files.
