...
The Notebook opens in a new browser window. You can create a new notebook or open a local one. Check out the local folder `work` for several sample notebooks. Open and run `08_mtcnn_face_detection_plot_landmarks1.ipynb` in the `work` folder.
