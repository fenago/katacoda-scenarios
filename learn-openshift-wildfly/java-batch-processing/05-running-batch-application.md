...
``curl -s -X POST -H 'Content-Type:application/json' --data "" "http://intro-jberet-jberet-lab.[[HOST_SUBDOMAIN]]-80-[[KATACODA_HOST]].environments.katacoda.com/intro-jberet/api/jobs/csv2db/start" | python -m json.tool``{{execute}}
